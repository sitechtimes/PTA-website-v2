...
<template>
    <header id="navbar" class="grid grid-cols-5">
        ...
        <div id="naV" class="grid grid-cols-4 max-[1024px]:hidden col-span-3"> 
             <div>
                <NuxtLink to="/" @click="('page=index')" class="w-8 mt-10 hover:opacity-50 flex flex-row text-lg font-bold">
            ...
            <div>
                <NuxtLink to="/events" class="w-8 mt-10 hover:opacity-50 flex flex-row text-lg font-bold">
            ...
            <div>
                <NuxtLink to="/contacts" class="w-8 mt-10 hover:opacity-50 flex flex-row text-lg font-bold whitespace-nowrap">
            ...
            <div>
                <NuxtLink to="/donate" class="w-8 mt-10 hover:opacity-50 flex flex-row text-lg font-bold">
                    <img class="icon" id="donate" src="/public/navbarIcons/creditCard.svg">
                    <div class="self-end ml-2">DONATE</div>
                </NuxtLink>
            </div>  
        </div>
        <Menu class="lg:hidden"></Menu>
    </header>
</template>
